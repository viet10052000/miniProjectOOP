...
public class TSPChromosome {
    ...
    private TSPChromosome(final List<TSPGene> chromosome) {
        this.chromosome = Collections.unmodifiableList(chromosome); // không thể sửa chromosome
        this.distance = calculateDistance();
    }


    // tạo 1 nhiễm sắc thể có points gene
    ...
    // tổng đường đi tất cả choromosome
