...
public class particle {
    ...
    public static int maximumIterations = 500;
    ...
    public Route getNeighborhoodSolution(Route aRoute)
    {
        ...
        TSPGene city_1 = aRoute.cities.get(random1);
        TSPGene city_2 = aRoute.cities.get(random2);
    ...
    public void swapWithLocation(int coeff)
    {
        for(int i = 0 ; i < coeff ; i++)
        {
            ...
            TSPGene city_1 = pBest.cities.get(random1);
            TSPGene city_2 = pBest.cities.get(random2);
